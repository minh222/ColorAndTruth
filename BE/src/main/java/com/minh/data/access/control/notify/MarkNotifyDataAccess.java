...
@Service
@DataAccess
public class MarkNotifyDataAccess { // gateway :mỗi bussiness truy cập 1 cổng.
    public final CurrentRepos rp;

    public MarkNotifyDataAccess(CurrentRepos repos) {
        this.rp = repos;
    }

    @Transactional
    public void markNotify(Long userId ) {
